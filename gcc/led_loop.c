...
//ativa display
#define DISP_BASE (PERIPH_BASE + 0b000000000000)
#define DISP_CONFIG_ADDR (DISP_BASE + 0b010000)
#define DISP_ENABLE_ADDR  (DISP_BASE + 0b000000)
#define DISP_DATA_ADDR (DISP_BASE + 0b100000)
#define DISP_INTERRUPT_ADDR (DISP_BASE + 0b110000)

#define DISP_CONFIG 0b0000000000000000
#define DISP_ENABLE 0b0000111111111000
#define DISP_DATA 0b000000000000000

//ativa timer
#define TIMER_BASE 0b000100000000
#define TIMER_N 0x100
...
// escrita timer
volatile unsigned int* timer_data = (volatile unsigned int*) TIMER_BASE;

//display
volatile unsigned int* seg7_data = (volatile unsigned int*) DISP_DATA;
volatile unsigned int* seg7_config = (volatile unsigned int*) DISP_CONFIG_ADDR;
volatile unsigned int* seg7_enable = (volatile unsigned int*) DISP_ENABLE_ADDR;

volatile int counter = 0;

void setup_display() {
	*seg7_enable = (volatile unsigned int) DISP_ENABLE;
	*seg7_config = (volatile unsigned int) DISP_CONFIG;
	*seg7_data = 0;
}
