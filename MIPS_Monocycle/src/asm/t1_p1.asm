...
main:   
    ...
    beq     $t1, $t2, main          # Obviamente, esta instru��o n�o deve saltar
    beq     $t1, $t1, equals        # Obviamente, esta instru��o deve saltar
    j main
equals:
    bne     $t2, $t2, main          # Obviamente, esta instru��o n�o deve saltar
    bne     $t1, $t2, next_i        # Obviamente, esta instru��o deve saltar
    j       main                    # Obviamente, esta instru��o nunca deve executar
